...
- **HA badge** on the side menu to quickly see the current leader node and overall cluster health:  
  ![PMM HA Status badge](../images/HA-Status.png)

- **Inventory integration** to view HA roles and health status for each node in your cluster:  
  ![PMM HA Inventory Nodes](../images/HA-inventory-nodes.png)

- **[PMM HA Health Overview dashboard](../reference/dashboards/dashboard-ha-health-overview.md)** for monitoring component health, resource usage, and pod status, specifically for HA Clustered deployments:  
