...
- **[PMM HA Health Overview dashboard](../reference/dashboards/dashboard-ha-health-overview.md)** to monitor component health, resource usage, and pod status, specifically for HA Clustered deployments.
